...
import { validateRegex,validateDocument2 } from "../../utility/formValidation";
...
const useStyles = makeStyles((theme) => ({
 ...
 function Dni({ values,setStep ,token,setInitState,showModal}) {
  ...
  //  setDni(value);
    const timeout = setTimeout(() => {
      ...
      validateDocument2(value,setLoading,setValidDocument)   
    }, 100);
  ...
  const styleDniContuner={ position: 'absolute', left: '50%', top: '50%',
  transform: 'translate(-50%, -50%)'}
  
  const delay = ms => new Promise(res => setTimeout(res, ms));
  return (
    <div className={classes.container1}
        style={!showModal?styleDniContuner:null}
    >  
    <View>
      <Card>
        <CardContent>
          ...
          <View style={{ flexDirection: "row" }}>
            <Button
              ...
              onClick={() => {
                ...
                validateDocument2(dni,setLoading,setValidDocument,() => {
