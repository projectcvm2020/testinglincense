...
import ListF from "../../../forms/internaUsage/employe/list";
import Detail from "../../../forms/internaUsage/employe/detail";
import { useLocation ,useHistory} from "react-router-dom";
import CircularProgress from "@material-ui/core/CircularProgress";
import { ToastContainer, toast } from 'react-toastify';
import 'react-toastify/dist/ReactToastify.css';
function employe({ token }) {
  ...
  const getItems = (load=false) => {
    ...
    getRequest("employe/getemploye?"+s+limit, token)
      .then((res) => {
        if (res.data) {
